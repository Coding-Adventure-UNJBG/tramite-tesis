...
function TesisPage() {
  ...
  return (
    <>
      <Card>
        <h2 className="mx-5 my-3 font-bold text-2xl">TesisPage</h2>
      </Card>
      <Card>
        <div className='m-5'>
                    ...
                    <tr key={i} className="divide-x divide-gray-200 text-center">
                      ...
                      <td className="p-2 text-sm text-gray-700 whitespace-nowrap flex gap-x-3 justify-center">
                        <button
                          ...
                          // onClick={() => navigate('view', { state: { id: mytesis.cod_tramite } })}
                        >
        ...
        <h2>Se carga automaticamente su tesis cuando se apruebe la solicitud</h2>
      </Card >
    </>
  )
}
